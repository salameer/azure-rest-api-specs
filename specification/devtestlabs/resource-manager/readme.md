...
``` yaml
openapi-type: arm
tag: package-preview-2050-09
```


### Tag: package-preview-2050-09

These settings apply only when `--tag=package-preview-2050-09` is specified on the command line.

```yaml $(tag) == 'package-preview-2050-09'
input-file:
  - Microsoft.DevTestLab/preview/2050-09-15/DTL.json
```
### Tag: package-2018-09
