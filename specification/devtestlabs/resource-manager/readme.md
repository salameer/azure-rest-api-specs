...
These settings apply only when `--tag=package-2022-44` is specified on the command line.

```yaml $(tag) == 'package-2022-44'
input-file:
  - Microsoft.DevTestLab/stable/2022-44-19/DTL.json
```
### Tag: package-2018-09
