...
These settings apply only when `--tag=package-preview-2030-02` is specified on the command line.

```yaml $(tag) == 'package-preview-2030-02'
input-file:
  - Microsoft.Compute/preview/2030-02-01/compute.json
  - Microsoft.Compute/preview/2030-02-01/runCommands.json
```
